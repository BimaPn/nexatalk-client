    ...
    <div className="w-full flex items-center justify-between gap-[9px] py-2 px-3 rounded-xl hover:bg-light dark:hover:bg-dark-netral relative z-0">
      ...
      <div className="w-full flex flex-col items-center">
        <div className="w-full flex items-center justify-between">
          ...
          <span className="text-[11.5px] text-semiDark dark:text-dark-light">{createdAt}</span>
        </div>
        <div className="w-full flex items-center justify-between">
          <span className={`w-[85%] text-[15px] text-semiDark dark:text-dark-light line-clamp-1 ${unread ? "font-bold":"font-normal"}`}>{message}</span>
          {unread && (
