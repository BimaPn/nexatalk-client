...
const Message = ({message,isCurrentUser=false,className}:Message) => {
  ...
  return (
    <div className={`${isCurrentUser ? "bg-primary text-white":"bg-white text-black dark:bg-dark-netral dark:text-white"} rounded-[9px] flexCenter px-2 py-[6px] ${className}`}>
